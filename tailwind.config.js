...
module.exports = {
  content: ["./src/**/*.{html,js,ts,tsx}", "./documentation/**/*.tsx"],
  important: true,
  purge: false,
  theme: {
    screens: {
      sm: "var(--bloom-screen-sm)",
      md: "var(--bloom-screen-md)",
      lg: "var(--bloom-screen-lg)",
      xl: "var(--bloom-screen-xl)",
      "2xl": "var(--bloom-screen-2xl)",
      print: { raw: "print" },
    },
    fontSize: {
    ...
    colors: {
      ...
      cyan: {
        900: "var(--bloom-color-cyan-900)",
        700: "var(--bloom-color-cyan-700)",
        500: "var(--bloom-color-cyan-500)",
        300: "var(--bloom-color-cyan-300)",
        100: "var(--bloom-color-cyan-100)"
      },
      orange: {
        900: "var(--bloom-color-orange-900)",
        700: "var(--bloom-color-orange-700)",
        500: "var(--bloom-color-orange-500)",
        300: "var(--bloom-color-orange-300)",
        100: "var(--bloom-color-orange-100)",
      },
      gray: {
    ...
    letterSpacing: {
      ...
      normal: "var(--bloom-letter-spacing-normal)",
