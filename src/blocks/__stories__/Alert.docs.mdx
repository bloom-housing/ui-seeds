...
The Alert, Message, and Toast components all share a common set of theme variables. You can set those variables simultaneously using `.common-message` along with `--common-message` variable prefixes, or you can individually customize `.alert`:
...
| `--alert-font-size`        | Component font size           | `--bloom-type-caption`         |
