...
import { CardExample } from "./Drawer.stories"
...
const longContent = (
  <>
    ...
    <p>
      A flower that grows in the wild, meaning it was not intentionally seeded or planted. The term
      implies that the plant probably is neither a hybrid nor a selected cultivar that is in any way
      different from the way it appears in the wild as a native plant, even if it is growing where
  ...
  return (
    <>
      ...
      <Dialog isOpen={isOpen} onClose={() => setIsOpen(false)}>
        ...
        <Dialog.Content>{longContent}</Dialog.Content>
        <Dialog.Footer>
          <Button variant="primary" size="sm" onClick={() => setIsOpen(false)}>
            OK
          </Button>
